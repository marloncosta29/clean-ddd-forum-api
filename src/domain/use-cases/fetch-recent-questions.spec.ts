...
describe('Fetch Recent Questions', () => {
    ...
    it('should be able fetch recent questions', async () =>{
        await questionRepository.create(makeQuestion({createdAt: new Date(2022, 0, 20)})) 
        await questionRepository.create(makeQuestion({createdAt: new Date(2022, 0, 18)})) 
        await questionRepository.create(makeQuestion({createdAt: new Date(2022, 0, 23)})) 
